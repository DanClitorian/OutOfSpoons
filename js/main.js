...
//
// v0.43.3: Solo Recovery Composition. Cache-bust (?v=433) na imporcie
// uiManager.js (zmienił zawartość — gameScreen.js dostał nowy query
// string). devTools.js NIE zmienił się w v0.43.3 — zostaje przy
// swoim aktualnym query.

import { initUI, showScreen } from "./ui/uiManager.js?v=433";
